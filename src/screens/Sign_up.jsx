  ...
  return (
    <div className="bg-white dark:bg-black pt-14 h-screen">
      ...
      <form>
        ...
        <div>
        <label for="firstname" className="inline-block mb-2 mt-2 ml-2">First Name</label>
        <input type="text" placeholder="Enter your first name" className="border-2 border-[#4A4A4A] rounded-lg p-2 w-2/3 ml-2"/>
        </div>

        <div>
        <label for="lastname" className="inline-block mb-2 ml-2">Last Name</label>
        <input type="text" placeholder="Enter your last name" className="border-2 border-[#4A4A4A] rounded-lg p-2 w-2/3 ml-2"/>
        </div>
